        ...
        foreach ($categories as $category) {
            ...
            foreach ($products as $product) {
                ...
                if (isset($properties)) {
                    ...
                    foreach ($prosOptions as $proOptions) {
                        $proId = DB::table('pros')->insertGetId([
                            'product_id' => $productId,
                            'count' => rand(1, 100),
                        ...
                        foreach ($proOptions as $proOption) {
                            $proData['pro_id'] = $proId;
                            $proData['property_option_id'] = $proOption;
                            $proData['created_at'] = Carbon::now();
                            $proData['updated_at'] = Carbon::now();

                            DB::table('pro_property_option')->insert($proData);
                        }
                    }
