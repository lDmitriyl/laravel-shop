        ...
        >
            <div>
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        @include('auth.layout.error', ['fieldName' => 'value'])
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        @include('auth.layout.error', ['fieldName' => 'currency_id'])
                ...
                'only_once' => 'Использован только 1 раз',
                ] as $field => $title)
                ...
                @endforeach
                    <div class="input-group row">
                        ...
                        <div class="col-sm-6">
                            @include('auth.layout.error', ['fieldName' => 'expired_at'])
